...
#define	TEA5760UK_FRQSET_HIGH_FR_13_08									MAKE_64BIT_MASK(0, 6)	 // Frequency setting bits 13 to 8
...
#define	TEA5760UK_FRQSET_LOW_FR_07_00									MAKE_64BIT_MASK(0, 8)	 // Frequency setting bits 7 to 0
...
#define	TEA5760UK_TNCTRL_AUDIO_SSL										MAKE_64BIT_MASK(5, 2)	 // Search stop-level threshold
...
#define	TEA5760UK_FRQCHK_HIGH_PLL_13_08									MAKE_64BIT_MASK(0, 6)	 // Detected frequency bits 13 to 8
#define	TEA5760UK_FRQCHK_HIGH_PLL_13_08_SHIFT							0

/* Detected frequency PLL word LSBs */
#define	TEA5760UK_FRQCHK_LOW											0x07
#define	TEA5760UK_FRQCHK_LOW_PLL_07_00									MAKE_64BIT_MASK(0, 8)	 // Detected frequency bits 7 to 0
...
#define	TEA5760UK_TUNCHK_IF_IF_6_0										MAKE_64BIT_MASK(1, 7)	 // Intermediate-frequency count
...
#define	TEA5760UK_TUNCHK_STATUS_LEV_3_0									MAKE_64BIT_MASK(4, 4)	 // Received-signal level count
...
#define	TEA5760UK_TESTREG_CONFIG_TB_3_0									MAKE_64BIT_MASK(0, 4)	 // Software-port test signal selection
...
#define	TEA5760UK_MANID_HIGH_MAN_ID_10_07								MAKE_64BIT_MASK(0, 4)	 // Manufacturer ID bits 10 to 7
#define	TEA5760UK_MANID_HIGH_MAN_ID_10_07_SHIFT							0
#define	TEA5760UK_MANID_HIGH_VERSION									MAKE_64BIT_MASK(4, 4)	 // Device version code
...
#define	TEA5760UK_MANID_LOW_MAN_ID_06_00								MAKE_64BIT_MASK(1, 7)	 // Manufacturer ID bits 6 to 0
#define	TEA5760UK_MANID_LOW_MAN_ID_06_00_SHIFT							1

/* Chip identification code MSBs */
#define	TEA5760UK_CHIPID_HIGH											0x0E
#define	TEA5760UK_CHIPID_HIGH_CHIP_ID_15_08								MAKE_64BIT_MASK(0, 8)	 // Chip ID bits 15 to 8
#define	TEA5760UK_CHIPID_HIGH_CHIP_ID_15_08_SHIFT						0

/* Chip identification code LSBs */
#define	TEA5760UK_CHIPID_LOW											0x0F
#define	TEA5760UK_CHIPID_LOW_CHIP_ID_07_00								MAKE_64BIT_MASK(0, 8)	 // Chip ID bits 7 to 0
