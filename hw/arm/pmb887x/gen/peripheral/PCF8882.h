...
#define	PCF8882_RDDIDIF_MODULE_CODE				MAKE_64BIT_MASK(0, 8)	 // Driver or module code
#define	PCF8882_RDDIDIF_MODULE_CODE_SHIFT		0
#define	PCF8882_RDDIDIF_VERSION					MAKE_64BIT_MASK(8, 7)	 // Driver or module version ID
...
#define	PCF8882_RDDIDIF_MANID					MAKE_64BIT_MASK(16, 8)	 // Manufacturer ID
...
#define	PCF8882_RDDST_PIXEL_FORMAT				MAKE_64BIT_MASK(20, 3)	 // Interface pixel format
...
#define	PCF8882_CASET_XE						MAKE_64BIT_MASK(0, 8)	 // End column from 0 to 131
#define	PCF8882_CASET_XE_SHIFT					0
#define	PCF8882_CASET_XS						MAKE_64BIT_MASK(8, 8)	 // Start column from 0 to 131
#define	PCF8882_CASET_XS_SHIFT					8

/* Set page write range */
#define	PCF8882_PASET							0x2B
#define	PCF8882_PASET_YE						MAKE_64BIT_MASK(0, 8)	 // End page from 0 to 175
#define	PCF8882_PASET_YE_SHIFT					0
#define	PCF8882_PASET_YS						MAKE_64BIT_MASK(8, 8)	 // Start page from 0 to 175
...
#define	PCF8882_PTLAR_AREA_END					MAKE_64BIT_MASK(0, 8)	 // Active-area end row
#define	PCF8882_PTLAR_AREA_END_SHIFT			0
#define	PCF8882_PTLAR_AREA_START				MAKE_64BIT_MASK(8, 8)	 // Active-area start row
#define	PCF8882_PTLAR_AREA_START_SHIFT			8

/* Set vertical-scroll areas */
#define	PCF8882_VSCRDEF							0x33
#define	PCF8882_VSCRDEF_BOTTOM_FIXED			MAKE_64BIT_MASK(0, 8)	 // Bottom fixed-area height
#define	PCF8882_VSCRDEF_BOTTOM_FIXED_SHIFT		0
#define	PCF8882_VSCRDEF_SCROLL_AREA				MAKE_64BIT_MASK(8, 8)	 // Scrollable-area height
#define	PCF8882_VSCRDEF_SCROLL_AREA_SHIFT		8
#define	PCF8882_VSCRDEF_TOP_FIXED				MAKE_64BIT_MASK(16, 8)	 // Top fixed-area height
...
#define	PCF8882_SEP_VALUE						MAKE_64BIT_MASK(0, 8)	 // Scroll entry row
...
#define	PCF8882_COLMOD_P						MAKE_64BIT_MASK(0, 3)	 // Interface pixel format
...
#define	PCF8882_RDID1_MANID						MAKE_64BIT_MASK(0, 8)	 // Manufacturer ID
#define	PCF8882_RDID1_MANID_SHIFT				0

/* Read module version ID */
#define	PCF8882_RDID2							0xDB
#define	PCF8882_RDID2_VERSION					MAKE_64BIT_MASK(0, 8)	 // Module version ID
#define	PCF8882_RDID2_VERSION_SHIFT				0

/* Read module ID */
#define	PCF8882_RDID3							0xDC
#define	PCF8882_RDID3_MODULE_ID					MAKE_64BIT_MASK(0, 8)	 // Module ID
