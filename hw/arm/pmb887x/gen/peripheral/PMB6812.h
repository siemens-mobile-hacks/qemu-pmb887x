...
#define	PMB6812_CHCTRL2_RVM							MAKE_64BIT_MASK(5, 3)	 // Charging-current measurement reference
...
#define	PMB6812_LEDCTRL1_LEDPWM						MAKE_64BIT_MASK(1, 6)	 // LED PWM duty-cycle code from 0 to 63
...
#define	PMB6812_USBCTRL_VALUE						MAKE_64BIT_MASK(0, 8)	 // Raw PMB6812 USB control value
