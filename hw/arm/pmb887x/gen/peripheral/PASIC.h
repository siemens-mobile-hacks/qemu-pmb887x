...
#define	PASIC_IDENTIFICATION_MODEL						MAKE_64BIT_MASK(0, 3)	 // Base model code
#define	PASIC_IDENTIFICATION_MODEL_SHIFT				0
#define	PASIC_IDENTIFICATION_REVISION					MAKE_64BIT_MASK(3, 4)	 // Hardware revision code
...
#define	PASIC_IRQ_MASK_1_VALUE							MAKE_64BIT_MASK(0, 8)	 // Interrupt mask bits
#define	PASIC_IRQ_MASK_1_VALUE_SHIFT					0

/* Second interrupt-mask byte */
#define	PASIC_IRQ_MASK_2								0x04
#define	PASIC_IRQ_MASK_2_VALUE							MAKE_64BIT_MASK(0, 8)	 // Interrupt mask bits
#define	PASIC_IRQ_MASK_2_VALUE_SHIFT					0

/* Stored shutdown reason */
#define	PASIC_TURNOFF_REASON							0x05
#define	PASIC_TURNOFF_REASON_VALUE						MAKE_64BIT_MASK(0, 8)	 // Shutdown reason code
...
#define	PASIC_SUPPLY_CONTROL_1_VREG2_LEVEL				MAKE_64BIT_MASK(1, 3)	 // VREG2A and VREG2B voltage level
#define	PASIC_SUPPLY_CONTROL_1_VREG2_LEVEL_SHIFT		1
#define	PASIC_SUPPLY_CONTROL_1_VREG3_LEVEL				MAKE_64BIT_MASK(4, 3)	 // VREG3 voltage level
...
#define	PASIC_RF_VOLTAGE_VRF1_LEVEL						MAKE_64BIT_MASK(0, 2)	 // RF regulator 1 level
#define	PASIC_RF_VOLTAGE_VRF1_LEVEL_SHIFT				0
#define	PASIC_RF_VOLTAGE_VRF2_LEVEL						MAKE_64BIT_MASK(2, 2)	 // RF regulator 2 level
#define	PASIC_RF_VOLTAGE_VRF2_LEVEL_SHIFT				2
#define	PASIC_RF_VOLTAGE_VRF3_LEVEL						MAKE_64BIT_MASK(4, 2)	 // RF regulator 3 level
...
#define	PASIC_POWER_WDT_TIME							MAKE_64BIT_MASK(0, 2)	 // Watchdog timeout
...
#define	PASIC_CHARGE_CONTROL_CURRENT					MAKE_64BIT_MASK(0, 2)	 // Charge current
...
#define	PASIC_CHARGE_STATUS_CURRENT						MAKE_64BIT_MASK(0, 8)	 // Raw current; firmware maps <0x1F to 0, otherwise ((value >> 5) + 1) x 200 mA
#define	PASIC_CHARGE_STATUS_CURRENT_SHIFT				0

/* Light PWM channel 1 level */
#define	PASIC_LIGHT_PWM1								0x12
#define	PASIC_LIGHT_PWM1_LEVEL							MAKE_64BIT_MASK(0, 7)	 // PWM level from 0 to 80
#define	PASIC_LIGHT_PWM1_LEVEL_SHIFT					0

/* Light PWM channel 2 level */
#define	PASIC_LIGHT_PWM2								0x13
#define	PASIC_LIGHT_PWM2_LEVEL							MAKE_64BIT_MASK(0, 7)	 // PWM level from 0 to 80
...
#define	PASIC_SWITCH_MUX_2_VALUE						MAKE_64BIT_MASK(0, 6)	 // Mux control value
...
#define	PASIC_PP_ROUTE_2_VALUE							MAKE_64BIT_MASK(0, 4)	 // Route selection from 0 to 8
#define	PASIC_PP_ROUTE_2_VALUE_SHIFT					0

/* Audio switch-mux path 4 */
#define	PASIC_SWITCH_MUX_4								0x4F
#define	PASIC_SWITCH_MUX_4_VALUE						MAKE_64BIT_MASK(0, 8)	 // Mux control value
#define	PASIC_SWITCH_MUX_4_VALUE_SHIFT					0

/* Amplifier paths 4 and 5 gain */
#define	PASIC_AMPLIFIER_GAIN_4_5						0x50
#define	PASIC_AMPLIFIER_GAIN_4_5_GAIN					MAKE_64BIT_MASK(0, 7)	 // Amplifier gain code
...
#define	PASIC_AMPLIFIER_GAIN_6_LEVEL					MAKE_64BIT_MASK(0, 8)	 // Gain code
#define	PASIC_AMPLIFIER_GAIN_6_LEVEL_SHIFT				0

/* Audio DAC control */
#define	PASIC_DAC_CONTROL								0x52
#define	PASIC_DAC_CONTROL_VALUE							MAKE_64BIT_MASK(0, 8)	 // DAC control bits
#define	PASIC_DAC_CONTROL_VALUE_SHIFT					0

/* Amplifier paths 7 and 8 gain */
#define	PASIC_AMPLIFIER_GAIN_7_8						0x53
#define	PASIC_AMPLIFIER_GAIN_7_8_GAIN					MAKE_64BIT_MASK(0, 7)	 // Amplifier gain code
...
#define	PASIC_AMPLIFIER_GAIN_9_GAIN						MAKE_64BIT_MASK(0, 7)	 // Amplifier gain code
#define	PASIC_AMPLIFIER_GAIN_9_GAIN_SHIFT				0

/* Audio switch-mux path 5 */
#define	PASIC_SWITCH_MUX_5								0x55
#define	PASIC_SWITCH_MUX_5_VALUE						MAKE_64BIT_MASK(0, 8)	 // Mux control value
#define	PASIC_SWITCH_MUX_5_VALUE_SHIFT					0

/* Audio mux-input selection */
#define	PASIC_MUX_INPUT									0x56
#define	PASIC_MUX_INPUT_VALUE							MAKE_64BIT_MASK(0, 8)	 // Mux input code
#define	PASIC_MUX_INPUT_VALUE_SHIFT						0

/* Audio switch-mux path 3 */
#define	PASIC_SWITCH_MUX_3								0x57
#define	PASIC_SWITCH_MUX_3_VALUE						MAKE_64BIT_MASK(0, 8)	 // Mux control value
#define	PASIC_SWITCH_MUX_3_VALUE_SHIFT					0

/* OUTPORT control */
#define	PASIC_OUTPORT_CONTROL							0x58
#define	PASIC_OUTPORT_CONTROL_MODE						MAKE_64BIT_MASK(0, 2)	 // OUTPORT operating mode
...
#define	PASIC_SAMPLE_RATE_ADC							MAKE_64BIT_MASK(0, 4)	 // ADC sample-rate code from 0 to 8
#define	PASIC_SAMPLE_RATE_ADC_SHIFT						0
#define	PASIC_SAMPLE_RATE_DAC							MAKE_64BIT_MASK(4, 4)	 // DAC sample-rate code from 0 to 8
#define	PASIC_SAMPLE_RATE_DAC_SHIFT						4

/* Stereo audio operating mode */
#define	PASIC_STEREO_MODE								0x5A
#define	PASIC_STEREO_MODE_VALUE							MAKE_64BIT_MASK(0, 8)	 // Stereo mode code
#define	PASIC_STEREO_MODE_VALUE_SHIFT					0

/* I2S receive-path control */
#define	PASIC_I2S_RX_CONTROL							0x5B
#define	PASIC_I2S_RX_CONTROL_VALUE						MAKE_64BIT_MASK(0, 8)	 // Receive control bits
#define	PASIC_I2S_RX_CONTROL_VALUE_SHIFT				0

/* I2S transmit-path control */
#define	PASIC_I2S_TX_CONTROL							0x5C
#define	PASIC_I2S_TX_CONTROL_VALUE						MAKE_64BIT_MASK(0, 8)	 // Transmit control bits
#define	PASIC_I2S_TX_CONTROL_VALUE_SHIFT				0

/* Additional audio-path control */
#define	PASIC_AUDIO_CONTROL_2							0x5D
#define	PASIC_AUDIO_CONTROL_2_VALUE						MAKE_64BIT_MASK(0, 8)	 // Raw control value
