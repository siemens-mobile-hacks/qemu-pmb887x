...
#define	PCF8833_RDDIDIF_MODULE_CODE				MAKE_64BIT_MASK(0, 8)	 // Driver or module code
#define	PCF8833_RDDIDIF_MODULE_CODE_SHIFT		0
#define	PCF8833_RDDIDIF_VERSION					MAKE_64BIT_MASK(8, 7)	 // Driver or module version ID
...
#define	PCF8833_RDDIDIF_MANID					MAKE_64BIT_MASK(16, 8)	 // Manufacturer ID
...
#define	PCF8833_RDDST_PIXEL_FORMAT				MAKE_64BIT_MASK(20, 3)	 // Interface pixel format
...
#define	PCF8833_SETCON_VCON						MAKE_64BIT_MASK(0, 7)	 // Two's-complement VLCD offset
...
#define	PCF8833_CASET_XE						MAKE_64BIT_MASK(0, 8)	 // End column from 0 to 131
#define	PCF8833_CASET_XE_SHIFT					0
#define	PCF8833_CASET_XS						MAKE_64BIT_MASK(8, 8)	 // Start column from 0 to 131
#define	PCF8833_CASET_XS_SHIFT					8

/* Set page write range */
#define	PCF8833_PASET							0x2B
#define	PCF8833_PASET_YE						MAKE_64BIT_MASK(0, 8)	 // End page from 0 to 131
#define	PCF8833_PASET_YE_SHIFT					0
#define	PCF8833_PASET_YS						MAKE_64BIT_MASK(8, 8)	 // Start page from 0 to 131
...
#define	PCF8833_PTLAR_AREA_END					MAKE_64BIT_MASK(0, 8)	 // Active-area end row
#define	PCF8833_PTLAR_AREA_END_SHIFT			0
#define	PCF8833_PTLAR_AREA_START				MAKE_64BIT_MASK(8, 8)	 // Active-area start row
#define	PCF8833_PTLAR_AREA_START_SHIFT			8

/* Set vertical-scroll areas */
#define	PCF8833_VSCRDEF							0x33
#define	PCF8833_VSCRDEF_BOTTOM_FIXED			MAKE_64BIT_MASK(0, 8)	 // Bottom fixed-area height
#define	PCF8833_VSCRDEF_BOTTOM_FIXED_SHIFT		0
#define	PCF8833_VSCRDEF_SCROLL_AREA				MAKE_64BIT_MASK(8, 8)	 // Scrollable-area height
#define	PCF8833_VSCRDEF_SCROLL_AREA_SHIFT		8
#define	PCF8833_VSCRDEF_TOP_FIXED				MAKE_64BIT_MASK(16, 8)	 // Top fixed-area height
...
#define	PCF8833_SEP_VALUE						MAKE_64BIT_MASK(0, 8)	 // Scroll entry row
...
#define	PCF8833_COLMOD_P						MAKE_64BIT_MASK(0, 3)	 // Interface pixel format
...
#define	PCF8833_SETVOP_VPR_04_00				MAKE_64BIT_MASK(0, 5)	 // VLCD operating-point low bits
#define	PCF8833_SETVOP_VPR_04_00_SHIFT			0
#define	PCF8833_SETVOP_VPR_08_05				MAKE_64BIT_MASK(8, 4)	 // VLCD operating-point high bits
...
#define	PCF8833_SETMUL_S						MAKE_64BIT_MASK(0, 2)	 // Voltage-multiplier factor
...
#define	PCF8833_TCVOPAB_SLA						MAKE_64BIT_MASK(0, 3)	 // Temperature slope A
#define	PCF8833_TCVOPAB_SLA_SHIFT				0
#define	PCF8833_TCVOPAB_SLB						MAKE_64BIT_MASK(4, 3)	 // Temperature slope B
#define	PCF8833_TCVOPAB_SLB_SHIFT				4

/* Set VLCD temperature slopes C and D */
#define	PCF8833_TCVOPCD							0xC4
#define	PCF8833_TCVOPCD_SLC						MAKE_64BIT_MASK(0, 3)	 // Temperature slope C
#define	PCF8833_TCVOPCD_SLC_SHIFT				0
#define	PCF8833_TCVOPCD_SLD						MAKE_64BIT_MASK(4, 3)	 // Temperature slope D
#define	PCF8833_TCVOPCD_SLD_SHIFT				4

/* Set segmented frame-frequency dividers */
#define	PCF8833_TCDF							0xC5
#define	PCF8833_TCDF_DFD						MAKE_64BIT_MASK(0, 7)	 // Temperature-region D divider
#define	PCF8833_TCDF_DFD_SHIFT					0
#define	PCF8833_TCDF_DFC						MAKE_64BIT_MASK(8, 7)	 // Temperature-region C divider
#define	PCF8833_TCDF_DFC_SHIFT					8
#define	PCF8833_TCDF_DFB						MAKE_64BIT_MASK(16, 7)	 // Temperature-region B divider
#define	PCF8833_TCDF_DFB_SHIFT					16
#define	PCF8833_TCDF_DFA						MAKE_64BIT_MASK(24, 7)	 // Temperature-region A divider
#define	PCF8833_TCDF_DFA_SHIFT					24

/* Set 8-color frame-frequency divider */
#define	PCF8833_DF8COLOR						0xC6
#define	PCF8833_DF8COLOR_DF8					MAKE_64BIT_MASK(0, 7)	 // 8-color frame-frequency divider
#define	PCF8833_DF8COLOR_DF8_SHIFT				0

/* Set LCD bias system */
#define	PCF8833_SETBS							0xC7
#define	PCF8833_SETBS_VB						MAKE_64BIT_MASK(0, 4)	 // LCD bias-system ratio
#define	PCF8833_SETBS_VB_SHIFT					0

/* Read measured temperature code */
#define	PCF8833_RDTEMP							0xC8
#define	PCF8833_RDTEMP_TD						MAKE_64BIT_MASK(0, 8)	 // Temperature code; T = 0.9375 x TD - 40 C
#define	PCF8833_RDTEMP_TD_SHIFT					0

/* Set N-line inversion interval */
#define	PCF8833_NLI								0xC9
#define	PCF8833_NLI_NLI							MAKE_64BIT_MASK(0, 8)	 // Inversion interval counter
#define	PCF8833_NLI_NLI_SHIFT					0

/* Read manufacturer ID */
#define	PCF8833_RDID1							0xDA
#define	PCF8833_RDID1_MANID						MAKE_64BIT_MASK(0, 8)	 // Manufacturer ID
#define	PCF8833_RDID1_MANID_SHIFT				0

/* Read module version ID */
#define	PCF8833_RDID2							0xDB
#define	PCF8833_RDID2_VERSION					MAKE_64BIT_MASK(0, 8)	 // Module version ID
#define	PCF8833_RDID2_VERSION_SHIFT				0

/* Read module ID */
#define	PCF8833_RDID3							0xDC
#define	PCF8833_RDID3_MODULE_ID					MAKE_64BIT_MASK(0, 8)	 // Module ID
...
#define	PCF8833_CALMODE_ORA						MAKE_64BIT_MASK(3, 3)	 // OTP register address
#define	PCF8833_CALMODE_ORA_SHIFT				3

/* Shift data into OTP registers */
#define	PCF8833_OTPSHTIN						0xF1
#define	PCF8833_OTPSHTIN_DATA					MAKE_64BIT_MASK(0, 8)	 // Arbitrary-length OTP data byte
