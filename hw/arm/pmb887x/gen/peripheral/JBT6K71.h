...
#define	JBT6K71_DRIVER_OUTPUT_CONTROL_NL			MAKE_64BIT_MASK(0, 6)	 // Driven LCD line-count selection
...
#define	JBT6K71_ENTRY_MODE_ID						MAKE_64BIT_MASK(4, 2)	 // Horizontal and vertical address directions
...
#define	JBT6K71_ENTRY_MODE_DFM						MAKE_64BIT_MASK(13, 2)	 // MPU display-data bit assignment
...
#define	JBT6K71_HORIZONTAL_VALID_WIDTH_HBP			MAKE_64BIT_MASK(0, 5)	 // Horizontal back porch in DOTCLK cycles
#define	JBT6K71_HORIZONTAL_VALID_WIDTH_HBP_SHIFT	0
#define	JBT6K71_HORIZONTAL_VALID_WIDTH_HWS			MAKE_64BIT_MASK(8, 8)	 // Horizontal valid width in DOTCLK cycles
...
#define	JBT6K71_DISPLAY_MODE_1_PT					MAKE_64BIT_MASK(6, 2)	 // Partial-display inactive-source state
#define	JBT6K71_DISPLAY_MODE_1_PT_SHIFT				6
#define	JBT6K71_DISPLAY_MODE_1_SPT					BIT(8)					 // Split-screen drive enable
#define	JBT6K71_DISPLAY_MODE_1_VLE					MAKE_64BIT_MASK(9, 2)	 // Per-screen vertical-scroll enable
#define	JBT6K71_DISPLAY_MODE_1_VLE_SHIFT			9
#define	JBT6K71_DISPLAY_MODE_1_COL					MAKE_64BIT_MASK(14, 2)	 // Display color depth
#define	JBT6K71_DISPLAY_MODE_1_COL_SHIFT			14

/* Vertical front and back porch timing */
#define	JBT6K71_DISPLAY_MODE_2						0x008
#define	JBT6K71_DISPLAY_MODE_2_BP					MAKE_64BIT_MASK(0, 4)	 // Vertical back porch in lines
#define	JBT6K71_DISPLAY_MODE_2_BP_SHIFT				0
#define	JBT6K71_DISPLAY_MODE_2_FP					MAKE_64BIT_MASK(8, 8)	 // Vertical front porch in lines
#define	JBT6K71_DISPLAY_MODE_2_FP_SHIFT				8

/* Partial-display refresh interval control */
#define	JBT6K71_DISPLAY_MODE_3						0x009
#define	JBT6K71_DISPLAY_MODE_3_RSH					MAKE_64BIT_MASK(0, 4)	 // Base refresh-field count
#define	JBT6K71_DISPLAY_MODE_3_RSH_SHIFT			0
#define	JBT6K71_DISPLAY_MODE_3_RSB					MAKE_64BIT_MASK(4, 2)	 // Refresh-field count multiplier
...
#define	JBT6K71_EXTERNAL_DISPLAY_1_RIM				MAKE_64BIT_MASK(0, 2)	 // RGB interface width and transfer mode
#define	JBT6K71_EXTERNAL_DISPLAY_1_RIM_SHIFT		0
#define	JBT6K71_EXTERNAL_DISPLAY_1_DM				MAKE_64BIT_MASK(4, 2)	 // Display synchronization source
...
#define	JBT6K71_FR_FREQUENCY_ADJUSTMENT_RTNI		MAKE_64BIT_MASK(0, 5)	 // Internal 1H clock-cycle count
#define	JBT6K71_FR_FREQUENCY_ADJUSTMENT_RTNI_SHIFT	0
#define	JBT6K71_FR_FREQUENCY_ADJUSTMENT_DIVI		MAKE_64BIT_MASK(8, 2)	 // Internal oscillator division ratio
#define	JBT6K71_FR_FREQUENCY_ADJUSTMENT_DIVI_SHIFT	8

/* External-DOTCLK line timing */
#define	JBT6K71_EXTERNAL_DISPLAY_2					0x00E
#define	JBT6K71_EXTERNAL_DISPLAY_2_RTNE				MAKE_64BIT_MASK(0, 8)	 // External 1H clock-cycle count
#define	JBT6K71_EXTERNAL_DISPLAY_2_RTNE_SHIFT		0
#define	JBT6K71_EXTERNAL_DISPLAY_2_DIVE				MAKE_64BIT_MASK(8, 2)	 // DOTCLK division ratio
...
#define	JBT6K71_LTPS_CONTROL_1_CLTI					MAKE_64BIT_MASK(0, 2)	 // ASW1 rising-edge position
#define	JBT6K71_LTPS_CONTROL_1_CLTI_SHIFT			0
#define	JBT6K71_LTPS_CONTROL_1_CLWI					MAKE_64BIT_MASK(8, 4)	 // ASW1/2/3 high-pulse width
#define	JBT6K71_LTPS_CONTROL_1_CLWI_SHIFT			8

/* Internal-clock OEV pulse timing */
#define	JBT6K71_LTPS_CONTROL_2						0x013
#define	JBT6K71_LTPS_CONTROL_2_OEVFI				MAKE_64BIT_MASK(0, 2)	 // OEV falling-edge position
#define	JBT6K71_LTPS_CONTROL_2_OEVFI_SHIFT			0
#define	JBT6K71_LTPS_CONTROL_2_OEVBI				MAKE_64BIT_MASK(8, 2)	 // OEV rising-edge position
#define	JBT6K71_LTPS_CONTROL_2_OEVBI_SHIFT			8

/* Internal-clock ASW hold timing */
#define	JBT6K71_LTPS_CONTROL_3						0x014
#define	JBT6K71_LTPS_CONTROL_3_SHI					MAKE_64BIT_MASK(0, 2)	 // ASW hold time after falling edge
#define	JBT6K71_LTPS_CONTROL_3_SHI_SHIFT			0

/* Internal-clock CKV1/2 edge timing */
#define	JBT6K71_LTPS_CONTROL_4						0x015
#define	JBT6K71_LTPS_CONTROL_4_CKFI					MAKE_64BIT_MASK(8, 2)	 // CKV1/2 leading-edge position
#define	JBT6K71_LTPS_CONTROL_4_CKFI_SHIFT			8
#define	JBT6K71_LTPS_CONTROL_4_CKBI					MAKE_64BIT_MASK(12, 2)	 // CKV1/2 trailing-edge position
#define	JBT6K71_LTPS_CONTROL_4_CKBI_SHIFT			12

/* External-clock ASW pulse timing */
#define	JBT6K71_LTPS_CONTROL_5						0x018
#define	JBT6K71_LTPS_CONTROL_5_CLTE					MAKE_64BIT_MASK(0, 4)	 // ASW1 rising-edge position
#define	JBT6K71_LTPS_CONTROL_5_CLTE_SHIFT			0
#define	JBT6K71_LTPS_CONTROL_5_CLWE					MAKE_64BIT_MASK(8, 6)	 // ASW1/2/3 high-pulse width
#define	JBT6K71_LTPS_CONTROL_5_CLWE_SHIFT			8

/* External-clock OEV pulse timing */
#define	JBT6K71_LTPS_CONTROL_6						0x019
#define	JBT6K71_LTPS_CONTROL_6_OEVFE				MAKE_64BIT_MASK(0, 4)	 // OEV falling-edge position
#define	JBT6K71_LTPS_CONTROL_6_OEVFE_SHIFT			0
#define	JBT6K71_LTPS_CONTROL_6_OEVBE				MAKE_64BIT_MASK(8, 4)	 // OEV rising-edge position
#define	JBT6K71_LTPS_CONTROL_6_OEVBE_SHIFT			8

/* External-clock ASW hold timing */
#define	JBT6K71_LTPS_CONTROL_7						0x01A
#define	JBT6K71_LTPS_CONTROL_7_SHE					MAKE_64BIT_MASK(0, 4)	 // ASW hold time after falling edge
#define	JBT6K71_LTPS_CONTROL_7_SHE_SHIFT			0

/* External-clock CKV1/2 edge timing */
#define	JBT6K71_LTPS_CONTROL_8						0x01B
#define	JBT6K71_LTPS_CONTROL_8_CKFE					MAKE_64BIT_MASK(8, 4)	 // CKV1/2 leading-edge position
#define	JBT6K71_LTPS_CONTROL_8_CKFE_SHIFT			8
#define	JBT6K71_LTPS_CONTROL_8_CKBE					MAKE_64BIT_MASK(12, 4)	 // CKV1/2 trailing-edge position
...
#define	JBT6K71_AMPLIFIER_CAPABILITY_ABSW			MAKE_64BIT_MASK(0, 2)	 // Operational-amplifier current capability
...
#define	JBT6K71_POWER_OFF_LINE_COUNT_POFH			MAKE_64BIT_MASK(0, 4)	 // Lines before VCS high-to-low transition
...
#define	JBT6K71_DISPLAY_CONTROL_D					MAKE_64BIT_MASK(4, 2)	 // Source output state
#define	JBT6K71_DISPLAY_CONTROL_D_SHIFT				4
#define	JBT6K71_DISPLAY_CONTROL_ASW					MAKE_64BIT_MASK(6, 2)	 // ASW output state
...
#define	JBT6K71_POWER_SUPPLY_CONTROL_1_VGM			MAKE_64BIT_MASK(0, 4)	 // VGM output voltage
#define	JBT6K71_POWER_SUPPLY_CONTROL_1_VGM_SHIFT	0
#define	JBT6K71_POWER_SUPPLY_CONTROL_1_VCS			MAKE_64BIT_MASK(4, 4)	 // VCS output voltage
#define	JBT6K71_POWER_SUPPLY_CONTROL_1_VCS_SHIFT	4
#define	JBT6K71_POWER_SUPPLY_CONTROL_1_VCD			MAKE_64BIT_MASK(8, 4)	 // VCOMD output voltage
...
#define	JBT6K71_POWER_SUPPLY_CONTROL_2_XVD			MAKE_64BIT_MASK(0, 3)	 // XVDD output voltage
...
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_CK1			MAKE_64BIT_MASK(0, 2)	 // AVDD-regulator clock division
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_CK1_SHIFT	0
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_CK2			MAKE_64BIT_MASK(2, 2)	 // XVDD-regulator clock division
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_CK2_SHIFT	2
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_CK3			MAKE_64BIT_MASK(4, 2)	 // External-regulator clock division
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_CK3_SHIFT	4
#define	JBT6K71_POWER_SUPPLY_CONTROL_4_DCW			MAKE_64BIT_MASK(8, 2)	 // DCCLK mask period
...
#define	JBT6K71_RAM_ADDRESS_LOW_AD_07_00			MAKE_64BIT_MASK(0, 8)	 // RAM address bits 7 to 0
...
#define	JBT6K71_RAM_ADDRESS_HIGH_AD_16_08			MAKE_64BIT_MASK(0, 9)	 // RAM address bits 16 to 8
...
#define	JBT6K71_GRAM_DATA_DATA						MAKE_64BIT_MASK(0, 18)	 // Display pixel data for the selected interface
#define	JBT6K71_GRAM_DATA_DATA_SHIFT				0

/* Display RAM write-mask bits 0 to 11 */
#define	JBT6K71_GRAPHIC_OPERATION_1					0x203
#define	JBT6K71_GRAPHIC_OPERATION_1_WM_05_00		MAKE_64BIT_MASK(0, 6)	 // Pixel write-mask bits 5 to 0
#define	JBT6K71_GRAPHIC_OPERATION_1_WM_05_00_SHIFT	0
#define	JBT6K71_GRAPHIC_OPERATION_1_WM_11_06		MAKE_64BIT_MASK(8, 6)	 // Pixel write-mask bits 11 to 6
...
#define	JBT6K71_GRAPHIC_OPERATION_2_WM_17_12		MAKE_64BIT_MASK(0, 6)	 // Pixel write-mask bits 17 to 12
#define	JBT6K71_GRAPHIC_OPERATION_2_WM_17_12_SHIFT	0

/* Gamma fine adjustments 0 and 1 */
#define	JBT6K71_GRAY_SCALE_1						0x300
#define	JBT6K71_GRAY_SCALE_1_PK0					MAKE_64BIT_MASK(0, 3)	 // Gamma fine adjustment 0
#define	JBT6K71_GRAY_SCALE_1_PK0_SHIFT				0
#define	JBT6K71_GRAY_SCALE_1_PK1					MAKE_64BIT_MASK(8, 3)	 // Gamma fine adjustment 1
#define	JBT6K71_GRAY_SCALE_1_PK1_SHIFT				8

/* Gamma fine adjustments 2 and 3 */
#define	JBT6K71_GRAY_SCALE_2						0x301
#define	JBT6K71_GRAY_SCALE_2_PK2					MAKE_64BIT_MASK(0, 3)	 // Gamma fine adjustment 2
#define	JBT6K71_GRAY_SCALE_2_PK2_SHIFT				0
#define	JBT6K71_GRAY_SCALE_2_PK3					MAKE_64BIT_MASK(8, 3)	 // Gamma fine adjustment 3
#define	JBT6K71_GRAY_SCALE_2_PK3_SHIFT				8

/* Gamma fine adjustments 4 and 5 */
#define	JBT6K71_GRAY_SCALE_3						0x302
#define	JBT6K71_GRAY_SCALE_3_PK4					MAKE_64BIT_MASK(0, 3)	 // Gamma fine adjustment 4
#define	JBT6K71_GRAY_SCALE_3_PK4_SHIFT				0
#define	JBT6K71_GRAY_SCALE_3_PK5					MAKE_64BIT_MASK(8, 3)	 // Gamma fine adjustment 5
#define	JBT6K71_GRAY_SCALE_3_PK5_SHIFT				8

/* Gamma inclination adjustments 0 and 1 */
#define	JBT6K71_GRAY_SCALE_4						0x303
#define	JBT6K71_GRAY_SCALE_4_PR0					MAKE_64BIT_MASK(0, 3)	 // Gamma inclination adjustment 0
#define	JBT6K71_GRAY_SCALE_4_PR0_SHIFT				0
#define	JBT6K71_GRAY_SCALE_4_PR1					MAKE_64BIT_MASK(8, 3)	 // Gamma inclination adjustment 1
#define	JBT6K71_GRAY_SCALE_4_PR1_SHIFT				8

/* Gamma amplitude adjustments 0 and 1 */
#define	JBT6K71_GRAY_SCALE_5						0x304
#define	JBT6K71_GRAY_SCALE_5_VR0					MAKE_64BIT_MASK(0, 3)	 // Gamma amplitude adjustment 0
#define	JBT6K71_GRAY_SCALE_5_VR0_SHIFT				0
#define	JBT6K71_GRAY_SCALE_5_VR1					MAKE_64BIT_MASK(8, 3)	 // Gamma amplitude adjustment 1
#define	JBT6K71_GRAY_SCALE_5_VR1_SHIFT				8

/* Blue-channel gamma offset control */
#define	JBT6K71_BLUE_OFFSET							0x305
#define	JBT6K71_BLUE_OFFSET_BOFS					MAKE_64BIT_MASK(0, 3)	 // Blue gamma-curve voltage offset
#define	JBT6K71_BLUE_OFFSET_BOFS_SHIFT				0
#define	JBT6K71_BLUE_OFFSET_BUP						MAKE_64BIT_MASK(4, 3)	 // Blue extreme-level voltage adjustment
...
#define	JBT6K71_VERTICAL_SCROLL_1_VL1				MAKE_64BIT_MASK(0, 9)	 // First-screen scroll amount in lines
#define	JBT6K71_VERTICAL_SCROLL_1_VL1_SHIFT			0

/* Second-screen vertical scroll offset */
#define	JBT6K71_VERTICAL_SCROLL_2					0x401
#define	JBT6K71_VERTICAL_SCROLL_2_VL2				MAKE_64BIT_MASK(0, 9)	 // Second-screen scroll amount in lines
...
#define	JBT6K71_SCREEN1_DRIVE_START_SS1				MAKE_64BIT_MASK(0, 9)	 // First-screen start line minus one
#define	JBT6K71_SCREEN1_DRIVE_START_SS1_SHIFT		0

/* First-screen gate-drive end position */
#define	JBT6K71_SCREEN1_DRIVE_END					0x403
#define	JBT6K71_SCREEN1_DRIVE_END_SE1				MAKE_64BIT_MASK(0, 9)	 // First-screen end line minus one
...
#define	JBT6K71_SCREEN2_DRIVE_START_SS2				MAKE_64BIT_MASK(0, 9)	 // Second-screen start line minus one
...
#define	JBT6K71_SCREEN2_DRIVE_END_SE2				MAKE_64BIT_MASK(0, 9)	 // Second-screen end line minus one
#define	JBT6K71_SCREEN2_DRIVE_END_SE2_SHIFT			0

/* Horizontal RAM window start */
#define	JBT6K71_HORIZONTAL_RAM_START				0x406
#define	JBT6K71_HORIZONTAL_RAM_START_HSA			MAKE_64BIT_MASK(0, 8)	 // Horizontal window start address
#define	JBT6K71_HORIZONTAL_RAM_START_HSA_SHIFT		0

/* Horizontal RAM window end */
#define	JBT6K71_HORIZONTAL_RAM_END					0x407
#define	JBT6K71_HORIZONTAL_RAM_END_HEA				MAKE_64BIT_MASK(0, 8)	 // Horizontal window end address
#define	JBT6K71_HORIZONTAL_RAM_END_HEA_SHIFT		0

/* Vertical RAM window start */
#define	JBT6K71_VERTICAL_RAM_START					0x408
#define	JBT6K71_VERTICAL_RAM_START_VSA				MAKE_64BIT_MASK(0, 9)	 // Vertical window start address
#define	JBT6K71_VERTICAL_RAM_START_VSA_SHIFT		0

/* Vertical RAM window end */
#define	JBT6K71_VERTICAL_RAM_END					0x409
#define	JBT6K71_VERTICAL_RAM_END_VEA				MAKE_64BIT_MASK(0, 9)	 // Vertical window end address
...
#define	JBT6K71_OSD_SCREEN1_START_ST1				MAKE_64BIT_MASK(0, 9)	 // First OSD screen start line
#define	JBT6K71_OSD_SCREEN1_START_ST1_SHIFT			0

/* Second OSD screen start position */
#define	JBT6K71_OSD_SCREEN2_START					0x505
#define	JBT6K71_OSD_SCREEN2_START_ST2				MAKE_64BIT_MASK(0, 9)	 // Second OSD screen start line
