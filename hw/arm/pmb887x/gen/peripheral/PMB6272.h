...
#define	PMB6272_CHANNEL1_FRACTION				MAKE_64BIT_MASK(4, 20)	 // Fractional channel word bits 19..0
#define	PMB6272_CHANNEL1_FRACTION_SHIFT			4

/* Synthesizer channel and operating mode */
#define	PMB6272_CHANNEL2						0x02
#define	PMB6272_CHANNEL2_FRACTION				MAKE_64BIT_MASK(4, 3)	 // Fractional channel word bits 22..20
#define	PMB6272_CHANNEL2_FRACTION_SHIFT			4
#define	PMB6272_CHANNEL2_INTEGER				MAKE_64BIT_MASK(7, 8)	 // Integer channel word
#define	PMB6272_CHANNEL2_INTEGER_SHIFT			7
#define	PMB6272_CHANNEL2_POWER_MODE				MAKE_64BIT_MASK(15, 2)	 // Transceiver power mode
...
#define	PMB6272_CHANNEL2_BAND					MAKE_64BIT_MASK(19, 2)	 // RF band
...
#define	PMB6272_RXTX_RXGAIN						MAKE_64BIT_MASK(4, 2)	 // Receiver gain
...
#define	PMB6272_RXTX_RXCORR						MAKE_64BIT_MASK(6, 4)	 // Receiver gain correction
#define	PMB6272_RXTX_RXCORR_SHIFT				6
#define	PMB6272_RXTX_RXCM						MAKE_64BIT_MASK(11, 2)	 // Mandatory receiver common-mode setting
...
#define	PMB6272_XO_INIT1_XOSETUP				MAKE_64BIT_MASK(16, 4)	 // Crystal-core capacitance adaptation
#define	PMB6272_XO_INIT1_XOSETUP_SHIFT			16
#define	PMB6272_XO_INIT1_XOCAL					MAKE_64BIT_MASK(20, 3)	 // Crystal subrange selection
...
#define	PMB6272_XO_INIT3_VALUE					MAKE_64BIT_MASK(4, 20)	 // Undocumented configuration value
#define	PMB6272_XO_INIT3_VALUE_SHIFT			4

/* Crystal oscillator linearization coefficients */
#define	PMB6272_XO_INIT2						0x0A
#define	PMB6272_XO_INIT2_ALPHA					MAKE_64BIT_MASK(4, 10)	 // LUXO alpha coefficient
#define	PMB6272_XO_INIT2_ALPHA_SHIFT			4
#define	PMB6272_XO_INIT2_GAMMA					MAKE_64BIT_MASK(14, 10)	 // LUXO gamma coefficient
#define	PMB6272_XO_INIT2_GAMMA_SHIFT			14

/* Crystal oscillator frequency correction */
#define	PMB6272_XO_TUNE							0x0C
#define	PMB6272_XO_TUNE_AFC						MAKE_64BIT_MASK(4, 17)	 // Frequency-correction value
